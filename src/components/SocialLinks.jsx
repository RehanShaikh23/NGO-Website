...
const SocialLinks = () => {
  return (
    <StyledWrapper>
      <div className="links">
        <a 
          href="https://www.instagram.com/visionforyouthfoundation?igsh=MXh0eXRlaDYyb2tlbA==" 
          target="_blank" 
        ...
        <a 
          href="https://www.linkedin.com/company/visionforyouth-foundation/posts/?feedView=images&viewAsMember=true" 
          target="_blank" 
          rel="noopener noreferrer"
          aria-label="LinkedIn"
        >
